          ...
          <div class="col">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade show active" id="tab1">
                <pre>
                  <h1>서비스이용약관</h1>처리한 개인정보는 다음의 목적 이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.
                  ...
                  개인정보의 처리 및 보유 기간
                  ① 잔디 서비스는 법령에 따른 개인정보 보유·이용 기간 또는 정보주체로부터 개인정보를 수집 시에 동의 받은 개인정보 보유, 이용 기간 내에서 개인정보를 처리, 보유합니다.
                  ② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.
                  개인정보파일명	운영목적	운영 근거(수집근거)	수집 항목	보유 기간
                  회원정보	잔디 서비스 이용	정보주체의 동의	(필수) 이메일, 비밀번호, 이름
                  (선택) 프로필 사진, 부서, 직책, 생년월일	회원탈퇴 시까지
                  개인정보의 제3자 제공에 관한 사항
                  ① 잔디 서비스는 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.
                  ② 잔디 서비스는 정보주체의 개인정보를 처리 목적으로 명시한 범위를 초과하여 제3자에게 제공하지 않습니다. 다만, 다음 각호의 경우에는 제3자에게 제공할 수 있습니다.
              ...
              <pre>
              <h1>개인정보처리방침</h1> 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적 이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.
              ...
              개인정보처리 위탁
              ① 잔디 서비스는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.
              ...
              쿠프마케팅	선물하기 서비스
              스티비	이메일 발송
              ② 잔디 서비스는 위탁계약 체결 시 개인정보 보호법 제26조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적·관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리·감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.
              ③ 토스랩은 개인정보를 국외의 다른 사업자에게 제공하지 않습니다. 다만, 정보시스템 운영 및 요금 결제, 고객 지원 등을 위해 위탁을 하고 있습니다. 위탁하는 업무에 대해서는 안전하게 관리될 수 있도록 관리와 감독을 시행하고 있습니다.
              ...
              ① 정보주체는 토스랩에 대해 언제든지 개인정보 열람, 정정, 삭제, 처리정지 요구 등의 권리를 행사할 수 있습니다.
              ② 제1항에 따른 권리 행사는 토스랩에 대해 개인정보 보호법 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 토스랩은 이에 대해 지체 없이 조치하겠습니다.
              ...
              ⑥ 토스랩은 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인 인지를 확인합니다.
              개인정보의 파기
              ...
              ① 토스랩은 개별적인 맞춤 서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다.
              ② 쿠키는 웹사이트를 운영하는 데 이용되는 서버(jandi.com)가 이용자의 컴퓨터 브라우저에 보내는 소량의 정보이며 이용자들의 PC 컴퓨터 내의 하드디스크에 저장되기도 합니다.
              ...
              ③ 토스랩은 여러분이 잔디 서비스를 이용할 때 자동으로 여러분이 사용하는 장치의 유형, 운영체제 버전, 장치 고유 식별번호를 수집합니다. 그 외에도 여러분의 신용카드 정보, 통신사 정보, 할인 코드 또는 상품권 번호, 또는 유료 서비스 사용 시 여러분이 잔디 서비스에서 결제하는데 필요한 다른 정보를 수집할 수 있습니다.
              ④ 모바일 분석: 토스랩은 여러분의 모바일 기기에서 잔디 애플리케이션 기능성을 더욱 잘 이해하기 위하여 모바일 분석 소프트웨어를 사용합니다. 이 소프트웨어는 애플리케이션 이용 빈도, 애플리케이션 내에서 발생한 사건, 집계된 사용량, 성능 데이터, 오류 정보 등의 정보를 기록할 수 있습니다.
              개인정보 보호책임자 지정
              ① 토스랩은 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만 처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
              가. 개인정보 보호책임자
              - 성명 :서준호
              - 직책 및 직급 : CTO
              ...
              ② 잔디 서비스를 이용하시는 모든 분은 토스랩의 서비스(또는 사업)를 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만 처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다.
              ③ 토스랩은 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
              개인정보 처리방침 변경
              ...
              ④ 해킹 등에 대비한 기술적 대책
              - 잔디 서비스는 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.
              ⑤ 개인정보의 암호화
              ...
              아래의 기관은 토스랩과는 별개의 기관으로서, 잔디 서비스의 자체적인 개인정보 불만 처리, 피해구제 결과에 만족하지 못하시거나 보다 자세한 도움이 필요하시면 문의하여 주시기 바랍니다.
              ...
              <div class="tab-pane fade show" id="tab3">
                <pre>
                <h1>전자금융거래 이용약관</h1> 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적 이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.
