...
public class InsertBoardDetailWebsocketHandler extends TextWebSocketHandler {
	...
	protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
		...
		// 수정된 게시글 상세 sort 변경후 DB 삽입
		boardDetail.setBoardDetailSort(boardDetail.getBoardDetailSort() + 1);
		
		int result = service.insertBoardDetail(boardDetail);
